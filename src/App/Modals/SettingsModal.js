            ...
            <ModalBody>
                ...
                <Form>
                    <TabContent activeTab={activeTab}>
                        <TabPane tabId="1">
                            <FormGroup>
                                <Input type="switch" id="accountCustomSwitch1" name="customSwitch"
                                             label="Allow connected contacts" defaultChecked/>
                            </FormGroup>
                            <FormGroup>
                                <Input type="switch" id="accountCustomSwitch2" name="customSwitch"
                                             label="Allow connected contacts" defaultChecked/>
                            </FormGroup>
                            <FormGroup>
                                <Input type="switch" id="accountCustomSwitch3" name="customSwitch"
                                             label="Profile privacy" defaultChecked/>
                            </FormGroup>
                            <FormGroup>
                                <Input type="switch" id="accountCustomSwitch4" name="customSwitch"
                                             label="Developer mode options"/>
                            </FormGroup>
                            <FormGroup>
                                <Input type="switch" id="accountCustomSwitch5" name="customSwitch"
                                             label="Two-step security verification" defaultChecked/>
                            </FormGroup>
                        </TabPane>
                        <TabPane tabId="2">
                            <FormGroup>
                                <Input type="switch" id="notificationCustomSwitch1" name="customSwitch"
                                             label="Allow mobile notifications" defaultChecked/>
                            </FormGroup>
                            <FormGroup>
                                <Input type="switch" id="notificationCustomSwitch2" name="customSwitch"
                                             label="Notifications from your friends"/>
                            </FormGroup>
                            <FormGroup>
                                <Input type="switch" id="notificationCustomSwitch3" name="customSwitch"
                                             label="Send notifications by email"/>
                            </FormGroup>
                        </TabPane>
                        <TabPane tabId="3">
                            <FormGroup>
                                <Input type="switch" id="securityCustomSwitch1" name="customSwitch"
                                             label="Suggest changing passwords every month."/>
                            </FormGroup>
                            <FormGroup>
                                <Input type="switch" id="securityCustomSwitch2" name="customSwitch"
